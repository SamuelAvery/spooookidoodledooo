...
scene.onOverlapTile(SpriteKind.Projectile, sprites.dungeon.doorLockedNorth, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`level24`)
    sprites.destroyAllSpritesOfKind(SpriteKind.Projectile)
    sprites.destroy(chest, effects.disintegrate, 100)
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.oceanDepths10, function (sprite, location) {
    game.showLongText("waaaaa!", DialogLayout.Top)
    sprites.destroy(mySprite, effects.clouds, 200)
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile39`, function (sprite, location) {
    plank = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . b b e c . . . . . . . 
        . . . . . c e b e . . . . . . . 
        . . . . . e e c e . . . . . . . 
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Food)
    tiles.placeOnRandomTile(plank, assets.tile`myTile39`)
    plank.follow(mySprite, 100)
...
scene.onOverlapTile(SpriteKind.Food, assets.tile`myTile51`, function (sprite, location) {
    sprites.destroy(rope)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestClosed, function (sprite, location) {
    ...
    chest = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Projectile)
    tiles.placeOnRandomTile(chest, sprites.dungeon.doorLockedNorth)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile50`, function (sprite, location) {
    ...
    rope = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Food)
    tiles.placeOnRandomTile(rope, assets.tile`myTile11`)
    rope.follow(mySprite, 100)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile41`, function (sprite, location) {
    key2 = sprites.create(assets.image`key2`, SpriteKind.Projectile)
    tiles.placeOnRandomTile(key2, assets.tile`myTile41`)
    key2.follow(mySprite, 100)
    tiles.setCurrentTilemap(tilemap`level44`)
})
scene.onOverlapTile(SpriteKind.Food, assets.tile`myTile40`, function (sprite, location) {
    sprites.destroy(plank, effects.none, 100)
    tiles.setCurrentTilemap(tilemap`level42`)
})
scene.onOverlapTile(SpriteKind.Projectile, assets.tile`myTile37`, function (sprite, location) {
    sprites.destroy(key2, effects.none, 100)
    tiles.setCurrentTilemap(tilemap`level48`)
    tiles.placeOnRandomTile(mySprite, assets.tile`myTile48`)
})
sprites.onDestroyed(SpriteKind.Player, function (sprite) {
    ...
    music.play(music.melodyPlayable(music.smallCrash), music.PlaybackMode.LoopingInBackground)
...
let plank: Sprite = null
let chest: Sprite = null
let mySprite: Sprite = null
Render.setViewMode(ViewMode.tilemapView)
music.play(music.stringPlayable("E F C5 A F A F B ", 111), music.PlaybackMode.LoopingInBackground)
...
info.setLife(3)
for (let index = 0; index < 1; index++) {
    game.showLongText("ohh crap!", DialogLayout.Top)
    game.showLongText("i have to be carefull", DialogLayout.Top)
    game.showLongText("this floor is weak", DialogLayout.Top)
    game.showLongText("dont wanna fall through", DialogLayout.Top)
}
